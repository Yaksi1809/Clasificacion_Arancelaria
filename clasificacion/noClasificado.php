...
$sql = "SELECT num_parte, cve_prov, fraccion, cve_imp, mercancia FROM noClasificado";
...
<body>
    ...
    <div style="display: flex; justify-content: center; gap: 10px; flex-wrap: wrap; margin-bottom: 10px;">
            ...
            <input type="text" id="buscador" placeholder="Buscar en la tabla..."><br><br>
            <form action="../importar/exportarPDFNoClas.php" method="POST" style="display: flex; align-items: center;">
